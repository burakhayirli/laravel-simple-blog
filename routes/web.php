...
Route::resource('makaleler','Back\ArticleController'); //resource ile oluşturulan controller
...
Route::get('/sayfalar/update/{id}','Back\PageController@update')->name('page.edit');
Route::post('/sayfalar/update/{id}','Back\PageController@updatePost')->name('page.edit.post');
Route::get('/sayfalar/sil/{id}','Back\PageController@delete')->name('page.delete');
Route::post('/sayfalar/create','Back\PageController@post')->name('page.create.post');
...
|--------------------------------------------------------------------------
*/
//sabit verdiğimiz urlleri başta tanımlamalıyız
